  ...
  static class UniCube
  {
    public static IEnumerable<Face3D> genFaces(Cube3D.RubikPosition masterPosition)
    {
      Color innerColor = Color.Transparent;
            double sticker = 0.86F;           // makes the sticker a bit smaller than the cubelet face so we can see through the cube
      return new Face3D[] {
		        new Face3D(new Point3D[] { new Point3D(-1 * sticker, 1 * sticker, -1), new Point3D(1 * sticker, 1 * sticker, -1), new Point3D(1 * sticker, -1 * sticker, -1), new Point3D(-1 * sticker, -1 * sticker, -1) }, innerColor, Face3D.FacePosition.Front, masterPosition, Face3D.SelectionMode.None),   
                new Face3D(new Point3D[] { new Point3D(-1 * sticker, 1 * sticker, 1), new Point3D(1 * sticker, 1 * sticker, 1), new Point3D(1 * sticker, -1 * sticker, 1), new Point3D(-1 * sticker, -1 * sticker, 1) }, innerColor, Face3D.FacePosition.Back, masterPosition, Face3D.SelectionMode.None),     
                new Face3D(new Point3D[] { new Point3D(-1 * sticker, -1, -1 * sticker), new Point3D(1 * sticker, -1, -1 * sticker), new Point3D(1 * sticker, -1, 1 * sticker), new Point3D(-1 * sticker, -1, 1 * sticker) }, innerColor, Face3D.FacePosition.Top, masterPosition, Face3D.SelectionMode.None),
                new Face3D(new Point3D[] { new Point3D(-1 * sticker, 1, -1 * sticker), new Point3D(1 * sticker, 1, -1 * sticker), new Point3D(1 * sticker, 1, 1 * sticker), new Point3D(-1 * sticker, 1, 1 * sticker) }, innerColor, Face3D.FacePosition.Bottom, masterPosition, Face3D.SelectionMode.None),      
                new Face3D(new Point3D[] { new Point3D(1, 1 * sticker, 1 * sticker), new Point3D(1, 1 * sticker, -1 * sticker), new Point3D(1, -1 * sticker, -1 * sticker), new Point3D(1, -1 * sticker, 1 * sticker) }, innerColor, Face3D.FacePosition.Right, masterPosition, Face3D.SelectionMode.None),     
                new Face3D(new Point3D[] { new Point3D(-1, 1 * sticker, 1 * sticker), new Point3D(-1, 1 * sticker, -1 * sticker), new Point3D(-1, -1 * sticker, -1 * sticker), new Point3D(-1, -1 * sticker, 1 * sticker) }, innerColor, Face3D.FacePosition.Left, masterPosition, Face3D.SelectionMode.None)
		    };
    }
